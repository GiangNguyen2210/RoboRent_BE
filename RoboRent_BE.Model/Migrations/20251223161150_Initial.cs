    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Robot lễ tân, chào đón khách, hỗ trợ check-in, hướng dẫn khu vực và hiển thị nội dung thương hiệu", false, "Reception Robot" },
                    { 2, "Robot biểu diễn sân khấu, nhảy múa, trình diễn theo show set và kịch bản được cấu hình", false, "Performance Robot" },
                    { 3, "Robot dẫn chương trình (MC), storytelling, đọc kịch bản theo timeline và tương tác với khán giả", false, "Host Robot" },
                    { 4, "Robot quảng bá thương hiệu, hỗ trợ booth, chạy nội dung marketing, CTA và thu hút khách tham dự", false, "Promotion Robot" }
                });
