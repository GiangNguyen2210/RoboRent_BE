    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "DOCS_RENTAL_BRIEF", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra có đầy đủ thông tin người phụ trách kỹ thuật, hotline, và hướng dẫn sử dụng nhanh (nếu có).", 0, false, true, 9, true, true, null, false, null, null, 10, "Tài liệu & thông tin bàn giao", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 2, null, "SAFETY_SERIAL_QR_MATCH", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Quét QR/đối chiếu serial trên robot với mã trong hệ thống trước khi giao.", 1, true, true, 8, true, true, "Serial/QR", true, null, null, 10, "Serial/QR đúng với hệ thống", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 3, null, "APPEARANCE_OVERALL_PHOTO", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Chụp ảnh toàn thân robot (ít nhất 2 góc) để làm bằng chứng tình trạng ban đầu.", 1, true, false, 1, true, true, null, false, null, null, 10, "Ảnh tổng quan robot trước bàn giao", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 4, null, "APPEARANCE_SCRATCH_DENT", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Quan sát thân vỏ, khớp nối, mặt trước/sau; ghi nhận trầy xước hoặc móp/nứt nếu có.", 1, true, true, 1, true, true, null, false, null, null, 20, "Trầy xước/móp/nứt vỏ", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 5, null, "POWER_BATTERY_LEVEL", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Bật robot và kiểm tra % pin (khuyến nghị ≥ 70% trước khi vận chuyển/giao).", 1, true, true, 2, true, true, "Battery (%)", true, null, null, 10, "Mức pin trước khi giao", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 6, null, "POWER_CHARGER_CABLES", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Đảm bảo có đủ sạc/adapter và dây nguồn đúng chuẩn, không đứt gãy.", 1, true, true, 7, true, true, null, false, null, null, 20, "Sạc/adapter/dây nguồn đầy đủ", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 7, null, "MOBILITY_BASIC_TEST", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra robot có thể đứng vững/di chuyển cơ bản theo khả năng (không cần chạy show).", 2, true, true, 3, true, true, null, false, null, null, 10, "Test di chuyển cơ bản", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 8, null, "AUDIO_SPEAKER_TEST", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Phát đoạn âm thanh mẫu; kiểm tra rè, nhỏ bất thường hoặc mất kênh.", 0, false, true, 4, true, false, null, false, null, null, 10, "Test loa (âm thanh)", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 9, null, "DISPLAY_SCREEN_OK", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra không sọc, không loang màu, cảm ứng/điều khiển hiển thị hoạt động.", 1, true, true, 5, true, true, null, false, null, null, 10, "Màn hình hiển thị bình thường", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 10, null, "ACCESSORIES_REMOTE_CONTROLLER", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra có đủ remote/controller và pin remote (nếu dùng).", 1, true, true, 7, true, false, null, false, null, null, 30, "Remote/thiết bị điều khiển (nếu có)", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 11, null, "SAFETY_CASE_PACKING", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Robot được cố định an toàn trong case/thùng; có chèn chống sốc.", 1, true, true, 8, true, true, null, false, null, null, 20, "Đóng gói/thùng/case vận chuyển đúng chuẩn", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 101, null, "RECEPTION_BRANDING_ASSETS_READY", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra đã có logo/banner/hình nền và giao diện màu sắc đúng theo yêu cầu khách.", 1, true, true, 5, true, true, null, false, 1, null, 10, "Branding assets đã nạp sẵn", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 102, null, "RECEPTION_QR_CTA_WORKING", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Mở màn hình QR/CTA; thử quét QR bằng điện thoại để đảm bảo điều hướng đúng link.", 1, true, true, 5, true, true, null, false, 1, null, 20, "QR/CTA hiển thị đúng & quét được", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 103, null, "RECEPTION_FAQ_SCRIPT_LOADED", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra danh sách câu chào và FAQ theo yêu cầu sự kiện (ngôn ngữ, giọng đọc).", 0, false, true, 0, true, false, null, false, 1, null, 10, "Kịch bản chào hỏi/FAQ đã cấu hình", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 201, null, "PERFORMANCE_SHOWSET_LOADED", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra danh sách tiết mục (nhạc, thời lượng, thứ tự) đã tải đúng phiên bản.", 1, true, true, 0, true, true, null, false, 2, null, 10, "Show set/playlist biểu diễn đã nạp", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 202, null, "PERFORMANCE_TRIGGER_METHOD_READY", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Xác nhận phương thức kích hoạt (manual/remote/schedule) hoạt động đúng.", 2, true, true, 0, true, true, null, false, 2, null, 20, "Cơ chế kích hoạt biểu diễn sẵn sàng", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 203, null, "PERFORMANCE_SAFETY_LIMITS_SET", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Xác nhận đã set vùng an toàn/khoảng cách/giới hạn tốc độ phù hợp kịch bản.", 0, false, true, 8, true, true, null, false, 2, null, 10, "Thiết lập giới hạn an toàn sân khấu", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 301, null, "HOST_SCRIPT_BLOCKS_READY", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra các khối nội dung lời dẫn theo timeline; đúng ngôn ngữ và thời lượng ước tính.", 1, true, true, 0, true, true, null, false, 3, null, 10, "Kịch bản MC (blocks) đã nạp", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 302, null, "HOST_VOICE_SETTINGS_OK", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra tốc độ/cao độ/âm lượng; đảm bảo nghe rõ và không gây chói.", 0, false, true, 4, true, true, null, false, 3, null, 20, "Thiết lập giọng nói phù hợp không gian", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 303, null, "HOST_MIC_TEST_IF_ANY", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra mic thu âm/khử ồn theo cấu hình; ghi nhận nếu micro yếu hoặc nhiễu.", 0, false, true, 4, true, false, null, false, 3, null, 10, "Test micro (nếu robot dùng mic)", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 304, null, "HOST_COUNTDOWN_OR_SLIDE_READY", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra nội dung countdown/slide/QR hiển thị đúng theo mốc chương trình.", 1, true, true, 5, true, false, null, false, 3, null, 30, "Countdown/slide hỗ trợ hiển thị sẵn sàng", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 401, null, "PROMO_MEDIA_PLAYLIST_READY", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra thứ tự, thời lượng và khả năng play mượt của playlist nội dung booth.", 2, true, true, 5, true, true, null, false, 4, null, 10, "Playlist quảng cáo (image/video) đã nạp", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 402, null, "PROMO_CTA_QR_COUPON_READY", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Kiểm tra QR/CTA/voucher đúng nội dung ưu đãi và quét ra đúng link/landing page.", 1, true, true, 5, true, true, null, false, 4, null, 20, "QR/CTA/voucher hiển thị đúng", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) },
                    { 403, null, "PROMO_PATROL_ROUTE_CONFIG", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038), "Xác nhận lộ trình, điểm dừng, khu vực tránh và tốc độ tối đa phù hợp booth.", 0, false, true, 3, true, false, null, false, 4, null, 20, "Lộ trình tuần tra/điểm dừng (nếu di chuyển)", new DateTime(2026, 1, 7, 12, 25, 49, 542, DateTimeKind.Utc).AddTicks(1038) }
                });
